...
<body>
    ...
    <script>
        ...
        const globeRadius = new MobileDetect(window.navigator.userAgent).mobile() ? 3 : 5;
    ...
    //     scene.add(atmosphere);
        ...
        function onPointerClick(event) {
            ...
            if (intersects.length > 0) {
                ...
                openModal(intersectedPoint.userData.title, intersectedPoint.userData.description);
